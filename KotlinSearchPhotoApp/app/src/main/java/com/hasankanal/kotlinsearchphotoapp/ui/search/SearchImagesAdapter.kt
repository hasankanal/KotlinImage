...
import com.hasankanal.kotlinsearchphotoapp.data.remote.UserDetails
import com.hasankanal.kotlinsearchphotoapp.utils.Constants
import kotlinx.android.synthetic.main.item_photo.view.*

class SearchImagesAdapter(private val context: Context, val onItemClick: (Photos) -> Unit): RecyclerView.Adapter<SearchImagesAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SearchImagesAdapter.ViewHolder {
        val view: View = LayoutInflater.from(parent.context).inflate(R.layout.item_photo, parent, false)
        return ViewHolder(view)
    }

    override fun onBindViewHolder(holder: SearchImagesAdapter.ViewHolder, position: Int) {
